const recensies = [
    {
        text: '	"We hebben een heel gezellige vakantie achter de rug.  Bedankt. We hebben genoten van jullie gastvrijheid !"',
    ...
    {
        text: '	"Wat een mooie plek waar jullie zitten ! Dikke merci om ons zo te verwennen?  Jullie gaan ons zeker nog een terug zien hier "',
        name: 'Danny en Sandra'
    },
    {
        text: '	"Ontzettend bedankt voor alle goede zorgen en jullie gastvrijheid.  Wat hebben we genoten van jullie prachtige plekje hier.  Echt tot rust komen en genieten van dit heerlijke plekje. We zullen dit zeker als tip meegeven aan andere mensen !  "',
